...
func TestRun(t *testing.T) {
	...
	err := os.WriteFile("testdata/0001.txt", []byte(inputConten), 0644)
	if err != nil {
	...
	// 出力ファイルの確認
	outputContent, err := os.ReadFile("testdata/0001.out")
	...
	// 後始末
	defer os.Remove("testdata/0001.txt")
	defer os.Remove("testdata/0001.out")
}
